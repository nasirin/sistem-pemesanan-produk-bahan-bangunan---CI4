                ...
                <form action="/User/insert" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8 col-lg-10">
                            <input type="text" class="form-control" id="id" name="username" value="<?= old('username'); ?>" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 col-lg-2 col-form-label">Password <span class="text-danger">*</span></label>
                        <div class="col-sm-8 col-lg-10">
                            <input type="text" class="form-control" name="password" placeholder="Masukan Nama User" value="<?= old('nama'); ?>" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 col-lg-2 col-form-label">No. Telepon <span class="text-danger">*</span></label>
                        <div class="col-sm-8 col-lg-10">
                            <input type="number" min="0" class="form-control" name="telp" placeholder="Masukan No. Telepon" value="<?= old('notelp'); ?>" required>
                        </div>
                    </div>
                    <div class="form-group row">
